...
import { fetchAllCryptoPrices, formatLastUpdated, isStaleByAge, type PriceEntry } from "@/lib/finance-port/marketData";
import { Input } from "@/components/ui/input";
import type { CryptoTransaction, CryptoDCASchedule } from "@/lib/finance-port/localStore";
import {
...
// fetchAllCryptoPrices is imported from @/lib/finance-port/marketData (CoinGecko→Binance fallback)
...
export default function CryptoPage() {
  ...
  const combinedProjection = useMemo(() => {
    ...
    return result;
  }, [cryptos, transactions, plannedOrders, dcaSchedules, fa]);
