          ...
          metrics={[
            {
              ...
              format: "percent",
              displayValues: [fmtPercent(survivalPct)],
            } satisfies DecisionRiskMetric,
            {
              ...
              format: "percent",
              displayValues: [fmtPercent(result.defaultProbability ?? 0)],
            } satisfies DecisionRiskMetric,
            {
              ...
              format: "percent",
              displayValues: [fmtPercent(result.liquidityStressProbability ?? 0)],
            } satisfies DecisionRiskMetric,
            {
              ...
              warnAt: 0.05, dangerAt: 0.20,
              format: "percent",
              displayValues: [fmtPercent(result.negativeEquityProbability ?? 0)],
            } satisfies DecisionRiskMetric,
            {
              ...
              warnAt: 0.10, dangerAt: 0.30,
              format: "percent",
              displayValues: [fmtPercent(result.refinancePressureProbability ?? 0)],
            } satisfies DecisionRiskMetric,
          ]}
