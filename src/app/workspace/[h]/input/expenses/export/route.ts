/**
 * GET /workspace/[h]/input/expenses/export
 *
 * Streams the household's expense ledger as a CSV download. Filter the
 * dataset via the same URL search params used by the page (year, month,
 * category, code, member, payment, search) so the download honours what
...
export async function GET(
  ...
  const header = [
    "date","amount","category","subcategory","source_code","member",
    "payment_method","label","cadence","is_debt_service","is_refund","notes",
  ];
