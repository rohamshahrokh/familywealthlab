...
// NOTE: Persistence, PDF, and AI-narrative modules are intentionally NOT
// vendored in Phase 1. They live in the personal app (live-app) and depend
// on browser-only libraries or app-specific Supabase clients. The commercial
// app re-implements persistence in `lib/dashboard/` and `lib/engine/`.
